package com.gmail.alexandr.tsiulkin.constant;

public interface PathConstant {

    String ACCESS_DENIED_PATH = "/access-denied";
    String ADMIN_PATH = "/admin";
    String WELCOME_ADMIN_PATH = "/welcome-admin";
    String SELLER_PATH = "/seller";
    String WELCOME_SELLER_PATH = "/welcome-seller";
